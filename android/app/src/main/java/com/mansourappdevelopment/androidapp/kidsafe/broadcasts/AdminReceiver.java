...
public class AdminReceiver extends DeviceAdminReceiver {
    ...
    public void onEnabled(Context context, Intent intent) {
        Toast.makeText(context, "تم تفعيل صلاحية المدير بنجاح", Toast.LENGTH_SHORT).show();
        deleted = false;
        writeToDB();
    }
    ...
    public void onDisabled(Context context, Intent intent) {
        Toast.makeText(context, "تحذير: تم إلغاء صلاحية المدير!", Toast.LENGTH_LONG).show();
        deleted = true;
        writeToDB();
    }
    ...
    private void writeToDB() {
        ...
        // البحث عن الطفل عن طريق الإيميل لتحديث حالته
